...
`docker run --network=host --name ssdp-relay scyto/multicast-proxy`
...
`docker run --network=host --name ssdp-relay -e INTERFACES="br0 br50 br60" -e OPTS="--verbose --noMDNS" scyto/multicast-relay`
...
`docker run --network=host --name ssdp-relay -e INTERFACES="br10 br75 br90 [etc] " scyto/multicast-relay`
